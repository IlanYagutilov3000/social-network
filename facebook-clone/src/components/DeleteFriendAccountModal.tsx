...
interface DeleteFriendAccountProps {
    show: boolean;
    onHide: Function;
    refresh: Function;
    userId: string;
...
const DeleteFriendAccount: FunctionComponent<DeleteFriendAccountProps> = ({ show, onHide, refresh, userId }) => {
...
export default DeleteFriendAccount;